...
STRIPE_PRICE_ID = _clean(os.getenv("STRIPE_PRICE_ID", ""))  # $25/mo
STRIPE_SPONSOR_PRICE_ID = _clean(os.getenv("STRIPE_SPONSOR_PRICE_ID", ""))  # $5K/mo sponsor
...
# --------------------
# Sponsor Pages + Sponsor Checkout ($5K/mo)
# --------------------
